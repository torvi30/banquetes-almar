...
export default function AdminDashboardPage() {
  ...
  return (
    <div className="container py-8 px-4 sm:px-6 max-w-7xl mx-auto">
      ...
      {/* KPI METRIC CARDS */}
      <div className="admin-summary mb-8">
        <div className="summary-card bg-zinc-900/70 border border-zinc-800/90 rounded-2xl p-5 backdrop-blur-md transition-all hover:border-amber-400/30">
          <div className="flex items-center justify-between mb-2">
            <span className="summary-title text-zinc-400 text-xs font-semibold uppercase tracking-wider">
              Total Recaudado
            </span>
          ...
          <strong className="text-2xl font-sans font-bold text-emerald-400 tracking-tight tabular-nums">
        ...
        <div className="summary-card bg-zinc-900/70 border border-zinc-800/90 rounded-2xl p-5 backdrop-blur-md transition-all hover:border-amber-400/30">
          ...
          <strong className="text-2xl font-sans font-bold text-amber-300 tracking-tight tabular-nums">
        ...
        <div className="summary-card bg-zinc-900/70 border border-zinc-800/90 rounded-2xl p-5 backdrop-blur-md transition-all hover:border-amber-400/30">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="w-7 h-7 rounded-lg bg-sky-500/10 text-sky-400 flex items-center justify-center">
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
              </svg>
            </span>
          </div>
          <strong className="text-2xl font-sans font-bold text-white tracking-tight tabular-nums">
            {metrics.totalEvents}
          </strong>
        </div>
        ...
        <div className="summary-card bg-zinc-900/70 border border-zinc-800/90 rounded-2xl p-5 backdrop-blur-md transition-all hover:border-amber-400/30">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="w-7 h-7 rounded-lg bg-purple-500/10 text-purple-400 flex items-center justify-center">
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
